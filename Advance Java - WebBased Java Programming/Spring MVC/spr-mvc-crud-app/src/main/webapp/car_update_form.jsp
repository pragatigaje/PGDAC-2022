...
<body>
	<spr:form action="car_update.htm" commandName="car" method="post" class="form align-items-center container px-4">
		<spr:hidden path="id" />
		<div class="">
		...
		<spr:button class="btn btn-secondary">Update</spr:button>
	</spr:form>
</body>
</html>