...
class ArrayListForUserDefinedComparator
{
	...
	public static void main(String args[])
	{
		...
		StudentRollComparator sroll = new StudentRollComparator();
		Collections.sort(list1,sroll);
		System.out.println("order using comparator");
		display(list1);
		
		System.out.println("--------------------------------------------------");
		
		System.out.println("Reverse order using comparator");
		Collections.sort(list1,Collections.reverseOrder(sroll));
		display(list1);
